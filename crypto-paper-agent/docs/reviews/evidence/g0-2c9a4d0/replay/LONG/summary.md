...
> **Generated At**: `2026-09-21T18:30:58.421883+00:00`  
...
| **Final Equity** | `$10,449.21 USDT` |
| **Net PnL** | `$+449.21 USDT` |
| **Total Return** | `+4.49%` |
| **Max Drawdown** | `-$170.90 USDT` (`1.68%`) |
| **Daily Sharpe Ratio** | `N/A` |
| **Calmar Ratio** | `2.67` |
| **Profit Factor** | `N/A (Loss = 0)` |
| **Expectancy (USD)** | `$+449.21` |
| **Expectancy (R)** | `+2.25 R` |
| **Loss Rate** | `0.00%` |
| **Average Realized RRR** | `+2.25 R` |
...
| **Số dư ví thực tế (Wallet Balance)** | `$10,449.21` | Trạng thái cuối kỳ |
| **Ký quỹ bị giữ (Reserved Collateral)** | `$0.00` | 0 khi kết thúc (force close) |
| **Hạn mức khả dụng (Available Margin)** | `$10,449.21` | Khả dụng mở vị thế mới |
| **Lãi/Lỗ chưa thực hiện (Unrealized PnL)** | `$0.00` | 0 khi tất toán |
| **Gross Price PnL** | `$+451.98` | Chênh lệch giá thuần |
| **Tổng phí giao dịch (Fees Paid)** | `-$2.77` | Phí taker |
| **Dòng tiền Funding (Funding Cashflow)** | `$+0.00` | Thanh toán định kỳ sàn |
| **Net Realized PnL** | `$+449.21` | Gross - Fees + Funding |
...
| **Win Rate** | `100.00%` |
| **Average Trade PnL** | `$+449.21` |
| **Average Win / Loss** | `$+449.21` / `-$0.00` |
| **Win / Loss Ratio** | `N/A` |
| **Max Consecutive Wins / Losses** | `1` / `0` |
| **Total Trading Fees** | `$2.77 USDT` |
